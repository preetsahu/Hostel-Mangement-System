Public Class rptEmpDateWiseAttendance

    Private Sub rptEmpDateWiseAttendance_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
